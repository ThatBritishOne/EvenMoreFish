...
/**
 * RAMPAGE competition strategy.
 * Players compete to catch the most fish while the competition makes fishing instant for all participants.
 * The instant-fishing effect is applied in FishingProcessor when this competition type is active.
 */
public class RampageStrategy implements CompetitionStrategy {
